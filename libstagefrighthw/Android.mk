...
ifneq (, $(filter msm7201a_ffa msm7201a_surf msm7627_ffa msm7627_surf qsd8250_ffa qsd8250_surf qsd8650a_st1x, $(QCOM_TARGET_PRODUCT)))
LOCAL_SRC_FILES := \
...
#Definition to log YUV
LOCAL_CFLAGS += -UOUTPUT_YUV_LOGGING
